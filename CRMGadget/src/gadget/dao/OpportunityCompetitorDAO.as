package gadget.dao
{
	...
	public class OpportunityCompetitorDAO extends SupportDAO
	{
		private var stmtDeleteByCompetitorId:SQLStatement = null;
		public function OpportunityCompetitorDAO(work:Function, sqlConnection:SQLConnection)
		{
			super(work, sqlConnection, {
				
				entity: ['Opportunity',   'Competitor'],
				id:     ['Id' ],
				columns: TEXTCOLUMNS
			}
				,{
					record_type:"OpportunityCompetitor",
					unique:['Id'],
					clean_table:false,
					must_drop :false,
			...
			stmtDeleteByCompetitorId.text = "DELETE FROM  opportunity_competitor WHERE CompetitorId = :CompetitorId";
		...
		override public function getLayoutFields():Array{
			var layoutFields:Array = [
				{data_type:"Picklist",display_name:"Opportunity Competitor",element_name:"CompetitorName",entity:this.entity,required:true},
