// semi-automatically generated from MedEdEvent.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class MedEdEventDAO extends BaseDAO {

		public function MedEdEventDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_meded',
				oracle_id: 'Id',
				name_column: [ 'Name' ],	//___EDIT__THIS___
				search_columns: [ 'Name'],
				display_name : "meded event",	//___EDIT__THIS___
				index: [ 'Id' ],
