// semi-automatically generated from CRMODLS_OBJECTIVE.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class ObjectivesDAO extends BaseDAO {
		
		public function ObjectivesDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_objectives',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
			//	display_name : "Objective",	//___EDIT__THIS___
				index: [ 'Id' ],
				columns: { 'TEXT' : textColumns }
			//	record_type:"objectives"
			});
		}
		...
		private var textColumns:Array = [
			...
			"AccountNameIntegrationId",
			"AccountNameStatus",
			"AccountNameAccountType",
			"AccountNameReference",
			"AccountNameExternalSystemId",
			"AccountNameOwner",
			"AccountNamePriority",
			"ContactNameContactEmail",
			"ContactNameContactFirstName",
			"ContactNameContactLastName",
			"ContactNameContactFullName",
			"ContactNameIntegrationId",
			"ContactNameAccountName",
			"ContactNameContactType",
			"ContactNameExternalSystemId",
			"ProductNameProductCategory",
			"ProductNameExternalSystemId",
			"ProductNameDescription",
			"ProductNameName",
			"ProductNamePartNumber",
			"ProductNameStatus",
			"ProductNameIntegrationId",
			"ProductNameType",
			"PeriodName",
			"PeriodStartDate",
			"PeriodEndDate",
